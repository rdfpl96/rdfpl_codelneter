                        ...
                        this.context.memo("button.addRowUp", (function() {
                            ...
                            return t.button({
                                ...
                                if (confirm("Are you sure you want to delete this row?")) {
                                    t.context.invoke('editor.deleteRow');
                                    $(this).off('click');
                                }
                            }
                            }).render()
                            ...
                            return t.button({
                                ...
                                if (confirm("Are you sure you want to delete this Column?")) {
                                    t.context.invoke('editor.deleteCol');
                                    $(this).off('click');
                                }
                        }
                            }).render()
                            ...
                            return t.button({
                                ...
                                if (confirm("Are you sure you want to delete this Table?")) {
                                    t.context.invoke('editor.deleteTable');
                                    $(this).off('click');
                                }
                        }
                            }).render()
                ...
                return e = t, (n = [{
                    ...
                    value: function() {
                        var t = this.options.dialogsInBody ? this.$body : this.options.container,
                            e = ['<div class="form-group note-form-group">',
                             ...
                             '<input id="note-dialog-link-txt-'.concat(this.options.id, '" class="note-link-text form-control note-form-control note-input" type="text" required/>'), 
                             "</div>", 
                             '<div class="form-group note-form-group">', 
                             '<label for="note-dialog-link-url-'.concat(this.options.id, '" class="note-form-label">').concat(this.lang.link.url, "</label>"),
                              '<span style="color:red">*</span>',
                              '<input id="note-dialog-link-url-'.concat(this.options.id, '" class="note-link-url form-control note-form-control note-input" type="text" value="http://"/ required>'), 
                              "</div>",
                               this.options.disableLinkTarget ? "" : i()("<div/>").append(this.ui.checkbox({
            ...
            var s = r.a.create('<div class="note-editor note-frame panel panel-default"/>'),
                ...
                y = r.a.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t, e) {
                    e.fade && t.addClass("fade"), t.attr({
                        "aria-label": e.title
                    }), t.html(['<div class="modal-dialog">', 
                        '<div class="modal-content">', 
                        e.title ? '<div class="modal-header1"><div class="row"><button type="button" class="btn-close" style="margin:10px 0px 0px 480px" data-bs-dismiss="modal" aria-label="Close"></button><h4 class="modal-title text-center" style="margin-top:-10px">' + e.title + "</h4></div></div>" : "", 
