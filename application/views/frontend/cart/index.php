...
<?php $this->load->view('frontend/header'); ?>
            ...
            <div class="col-lg-8 d-flex justify-content-center align-items-center">
               ...
               <?php } else { ?>
                  <div class="alert alert-warning">
                     <strong>Warning! </strong>Delevery Not available on the current address.Please Change Addres.s <a href="<?php echo base_url('delivery-address')?>" class="alert-link">Click Here</a>.
                  </div>
               <?php } ?>
                                 ...
                                 <div class="main_basket_product_quantity_btn">
                                    <div class="detail-extralink">
                                       ...
                                       <div class="quantity-controls w-100 hover-up width100 common-button">
                                          <button class="quantity-decrease"><span class="material-symbols-outlined" onclick="itemtIncreamentFromCart(<?php echo $product['product_id']; ?>,1,<?php echo $product['price']; ?>,<?php echo $product['before_off_price']; ?>,<?php echo $product['cart_id']?>);">remove</span></button>
                                          <input type="text" class="quantity-input" id="qty<?php echo $product['product_id']; ?>" value="<?php echo $product['cart_qty']?>">
                                          <button class="quantity-increase" onclick="itemtIncreamentFromCart(<?php echo $product['product_id']; ?>,2,<?php echo $product['price']; ?>,<?php echo $product['before_off_price']; ?>,<?php echo $product['cart_id']?>);" ><span class="material-symbols-outlined">add</span></button>
                                       </div>
   ...
   <?php } else{ ?>
      <div class="alert alert-warning">
       <strong>Warning!</strong> You <a href="#" class="alert-link">Cart is empty</a>.
     </div>
   <?php } ?>   
