    ...
    <div class="card-body"><br>
        ...
        <div class="row shipping_calculator">
           <div class="form-group col-lg-4">
                ...
                <input type="text" name="state" id="state" placeholder="Enter Landmark for easy reach out" value="<?php echo isset($address) ? htmlspecialchars($address[0]->state) : ''; ?>">

            </div>
            <div class="form-group col-lg-4">
                <label for="" class="form-label">City</label>
                <input type="text" name="city" id="city" placeholder="Enter Landmark for easy reach out" value="<?php echo isset($address) ? htmlspecialchars($address[0]->city) : ''; ?>">
            </div>
            <div class="form-group col-lg-4">
