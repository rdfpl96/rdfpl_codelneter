    <form action="<?php echo base_url('save-gst')?>" method="post" id="gstform" name="gstform" onsubmit="saveGst();return false;">
        <div class="row">
            ...
            <div class="form-group col-lg-6">
                <button type="submit" class="width_auto btn sub-regi btn-fill-out btn-base submit-registration">Submit</button>
            </div>
        </div>
    </form>    
