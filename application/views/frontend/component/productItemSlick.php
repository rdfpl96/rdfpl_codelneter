...
<?php
   ...
   if(isset($productItems) && is_array($productItems) && count($productItems)>0){ 
    ...
    ?>
   <div class="col-lg-1-<?php echo isset($pcol) ? $pcol : 4; ?> col-md-4 col-12 col-sm-6 slick-slide slick-active" style="width: 314px;">
      <div class="product-cart-wrap mb-30">
         ...
         <div class="btn_group">
            <div class="save_for_later_btn">
               <!-- <div id="wisf"> -->
               <a href="javascript:void(0);" title="Wishlist" class="wish-div" data-id="NA==" tabindex="0">
