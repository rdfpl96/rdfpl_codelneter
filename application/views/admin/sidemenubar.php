...
$admin_type = $this->session->userdata('admin_type'); // Fetch logged-in user's role

//echo "<pre>"; print_r($admin_type); die();
?>
      ...
      <ul class="menu-list flex-grow-1 mt-3" id="sidebar_nav">
         ...
         <li>
            <a class="m-link " href="<?php echo base_url('admin/coupon'); ?>"><i class="icofont-chart-flow"></i> <span>Coupons</span> </a>
               ...
               <li>
                  <a class="m-link" href="<?php echo base_url('admin/user_list'); ?>">
         ...
         <li>
            ...
            <!-- <a class="m-link" href="<?php // echo base_url('admin/ads_banner'); 
                                          ?>"><i class="icofont-chart-flow"></i> <span>Ads Banner List</span></a> -->
         </li>
         <li>
