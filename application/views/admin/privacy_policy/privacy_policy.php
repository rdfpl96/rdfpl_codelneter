                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            ...
                            <h3 class="fw-bold mb-0">Privacy Policy</h3>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-xl-12 col-lg-12">
                        <div class="sticky-lg-top">
                            <div class="card mb-3">
                                <input type="hidden" class="form-control" name="field_type" id="field_type" value="admin/privacy-policy">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            <textarea id="summernote" name="designation"><?php echo ($policy_details != 0) ? $policy_details[0]->privacy_policy : ''; ?></textarea>
                                            <p id="errr"></p>
                                        </div>
                                    </div>
                                </div>
