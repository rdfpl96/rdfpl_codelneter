                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control pname" id="product-name" name="product_name" value="<?php echo isset($tdata['product_name']) ? stripslashes($tdata['product_name']) : ''; ?>" required placeholder="Please product name">
                                        </div>
                                        <div class="col-md-6">
                                                    ...
                                                    <div class="center" style="text-align: center;">
                                                        ...
                                                        <div class="form-input">
                                                            <div class="preview">
                                                                ...
                                                                <input type="text" name="image_path<?php echo $key + 1; ?>" id="image_path<?php echo $key + 1; ?>" value="<?php echo isset($tdata[$image_field]) ? $tdata[$image_field] : ''; ?>" hidden>
                                                            </div>
