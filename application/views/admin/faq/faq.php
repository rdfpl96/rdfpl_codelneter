                ...
                <div class="row g-3 mb-3">
                    <div class="col-xl-12 col-lg-12">
                        <div class="sticky-lg-top">
                            <div class="card mb-3">
                                <input type="hidden" class="form-control" name="field_type" id="field_type" value="admin/faq">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            <textarea id="summernote" name="designation"><?php echo ($policy_details != 0) ? $policy_details[0]->faq : ''; ?></textarea>
                                            <p id="errr"></p>
                                        </div>
                                    </div>
                                </div>
