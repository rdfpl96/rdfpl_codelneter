                                 ...
                                 <?php
                                  ...
                                  if((in_array('add',$actAcx) || in_array('edit',$actAcx)) || $session['admin_type']=='A'){ 
                                    ?>
                                      ...
                                      <button type="button" class="btn custom_top_btn_css btn-primary py-2 px-5 text-uppercase btn-set-task cat-bt w-sm-100 cate-save" <?php echo $desabledAtrr;?>>Save </button>
                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-5">
                              <label  class="form-label">Category Image</label>
                                 ...
                                 <input type="hidden" id="image-file-path" name="uplofile_path" class="form-control" value="<?php echo ($category_detaials!=0) ? $category_detaials[0]->cat_image :'';?>">
                                 <input type="hidden" id="cat-ci" name="ci_cat_name" class="form-control" value="<?php echo ($category_detaials!=0) ? $category_detaials[0]->ci_cat_name :'';?>">
