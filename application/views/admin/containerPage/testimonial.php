                    ...
                    <div class="row align-items-center">
                        <div class="border-0">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <h3 class="fw-bold mb-0">Testimonial List</h3>
                                 <?php if(in_array('add',$getAccess['inputAction']) || $session['admin_type']=='A'){ ?>
                                    <a href="<?php echo base_url('admin/add_testinonial');?>"><button type="button" class="btn btn-primary py-2 px-5 text-uppercase btn-set-task w-sm-100 add-user">Add testimonial</button></a>
                             <?php } ?>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                ...
                                <div class="card-body">
                                  <div class="table-responsive">
                                    <table class="table table-hover align-middle mb-0" style="width: 100%;">
                                        ...
                                        <tbody class="row_position_testi">
                                            <?php  
                                                   ...
                                                   $index++;
                                                    ?>
                                                     ...
                                                     <tr id="<?php echo $value->testi_id;?>">
                                                        ...
                                                        <td>
                                                             <label class="switch">
                                                               <input type="checkbox" data-id="<?php echo base64_encode($value->testi_id.':::'.implode(',',$ActiveInactive_ActionArr));?>" class="cate-status" <?php echo ($value->status==1) ?'checked' :'';?>>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic outlined example" style="float: right;">
                                                                ...
                                                                <a href="<?php echo base_url('admin/add_testinonial/'.$value->testi_id);?>" class="btn btn-outline-secondary"><i class="icofont-edit text-success"></i></a>
                                                            <?php } ?>
                                                              <?php if(in_array('delete',$getAccess['inputAction']) || $session['admin_type']=='A'){ ?>
                                                                <button type="button" class="btn btn-outline-secondary deleteRowClass" id="deleteRow<?php echo $value->testi_id;?>" data-id="<?php echo base64_encode($value->testi_id.':::'.implode(',',$deleteActionArr));?>"><i class="icofont-ui-delete text-danger"></i></button>
                                                                <?php } ?>
                                                            </div>
                                                        </td>
                                                    </tr>
