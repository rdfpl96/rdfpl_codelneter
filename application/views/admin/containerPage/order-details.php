                    ...
                    <div class="col">
                        <div class="alert-danger alert mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-3 text-truncate">
                                    <div class="h6 mb-0">Name</div> <?php  echo $order_details[0]['customer_name'];?>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><p class="price"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $pvalue['order_amount']; ?></p></td>
                                                            </tr>
                                                    <?php
                                                            }
                                                        }
