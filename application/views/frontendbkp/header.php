                                ...
                                <div id="wishit">  
                                  <div class="header-action-icon-2 header_wish_style">  
                                    <a href="<?php echo base_url('wishlist');?>">
                                        ...
                                        <span class="pro-count blue"><?php echo $this->customlibrary->getWishListCount($customerId);?></span>
                                    </a>
                                    <!-- <a href="<?php echo base_url('wishlist');?>"><span class="lable">Wishlist</span></a> -->
                                   </div>
                                </div>
                            </div>
                                    ...
                                    <!-- Default dropend button -->
                                       <div class="user_icon_group">
                                           ...
                                           <ul class="dropdown-menu">
                                                ...
                                                <li><a class="d-flex justify-content-between" href="<?php echo base_url('cart');?>">My Basket <span><?php echo $this->cart->total_items();?> Items</span></a></li>
                     ...
                     <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                           <ul class="category-menu">
                              ...
                              <li><a href="#">Foodgrains &amp; Oils</a></li>
                              <li><a href="#">Dry Fruits &amp; Nuts</a></li>
                              <li class="more-categories">
                                 <a class="active" href="#">&gt;&gt;</a>
                                 <ul class="sub-menu">
                                    <li><a href="#">Spices &amp; Condiments</a></li>
                                    <li><a href="#">Beverages</a></li>
                                    <li><a href="#">Pooja Samagri, Salt, Sugar &amp; Jaggery</a></li>
                                    <li><a href="#">Snacks &amp; Branded Foods</a></li>
                                    <li><a href="#">Grocery &amp; Home Baking</a></li>
                                    <li><a href="#">Dried vegetables</a></li>
                                    <li><a href="#">Ayurvedic Herbs &amp; Seeds</a></li>
