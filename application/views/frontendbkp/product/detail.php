                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
                     <div class="detail-info product_details_main_sec pr-30 pl-30">
                        ...
                        <div class="grid_product_rating mt-10">
                           ...
                           <a href="https://uat.rdfpl.com/rating-review-details"><span class="text-muted">&nbsp; <u>5171 Ratings &amp; 70 Reviews</u></span></a>
                        </div>
                        <div class="product_details_price mt-20">
                           <p class="text-muted-low"><span>MRP </span><span><strike>₹<?php echo isset($firstItem['before_off_price']) ? $firstItem['before_off_price'] : '' ?></strike></span></p>
                        ...
                        <a href="#product_details_offer_ad">
                           <div class="grid_offer_ad mt-20">
                              <div class="ad_btn" style="width: 70%;">
                        ...
                        <div class="detail-extralink mb-50">
                           <div class="product-extra-link2">
                              ...
                              <a href="javascript:void(0);" title="Wishlist" class="wish-div product_save_for_later_btn" data-id="NDc1" onclick="wishlist();">
                           ...
                           <div class="product_details_pack_sizes d-block mt-30">
                              ...
                              <ul class="cust_select_lists">
                                <?php foreach ($items as $item) { ?>
                                    ...
                                    <li>
                                    <a data-value="1kg" tabindex="0">
                                       <div class="kg_name"><?php echo $item['pack_size']?><?php echo $item['units']?></div>
                                       <div class="off_ad_btn">
                                          ...
                                          <div class="product-price">
                                             ...
                                             <strike><span style="font-size: 16px;font-weight: 400;color: #787878;"><span style="font-size: 16px;font-weight: 500;color: #787878;">MRP ₹</span><span style="font-size: 16px;font-weight: 500;color: #787878;" class="beforeOffprice841"><?php echo $item['before_off_price']?></span></span></strike>
                                          </div>
