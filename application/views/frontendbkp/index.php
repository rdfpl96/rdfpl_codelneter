    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 " data-wow-delay=".4s">
            <div class="carausel-4-columns-cover arrow-center position-relative">
                ...
                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-featured">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 " data-wow-delay=".4s">
            <div class="carausel-4-columns-cover arrow-center position-relative">
               ...
               <!-- <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-top-selling">-->
               <!--   <?php-->
               <!--   // if($Topselling!=array()){-->
               <!--         //$topSelling['itemDisplyNummber']=5;-->
               <!--         //$topSelling['products']=$Topselling;-->
               <!--         //$topSelling['unique']='tab-slide';-->
               <!--         //$this->load->view('frontend/containerPage/productItem',$topSelling);-->
               <!--    // }else{-->
               <!--     ?>-->
               <!--       <div class="blank" style="text-align: center;font-size: 16px;">No Data </div>-->
               <!--     <?php-->
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 " data-wow-delay=".4s">
            <div class="carausel-4-columns-cover arrow-center position-relative">
                ...
                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-newly-launch">
                <?php
                   if($Newproduct!=array()){
                        $value1['itemDisplyNummber']=5;
                        //$datadaily['category']=$value;
                        $value1['products']=$Newproduct;
                        $value1['unique']='tab-slide';
                        $this->load->view('frontend/containerPage/productItem',$value1);
                    }else{
                    ?>
                      <div class="blank" style="text-align: center;font-size: 16px;">No Data </div>
                    <?php
    ...
    <div class="container">
        ...
        foreach ($categories as $category) {
            if ($current_category != $category['category']) {
                if ($current_category != '') {
                    echo '</div></div></div>'; // Close previous category section
                }
        ...
        ?>
                        <div class="col-md-2">
                            <div class="home_cat_img">
                                <a href="">
                                    <img src="<?php echo base_url('uploads/subcategory/' . $category['subcat_image']); ?>" alt="<?php echo $category['subCat_name']; ?>" />
                                    <p><?php echo $category['subCat_name']; ?></p>
                                </a>
                            </div>
                        </div>
        <?php
        ...
        if ($current_category != '') {
            echo '</div></div></div>'; // Close the last category section
        }
        ?>
    </div>
</section>
