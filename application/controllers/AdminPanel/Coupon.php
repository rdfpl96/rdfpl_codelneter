...
class Coupon extends CI_Controller
{
    ...
    //     $config["total_rows"] = $this->coupon->record_count($name);
    //     $config["per_page"] = 4;
    ...
    //     $start = $page;
    //     $data['copun_list'] = $this->coupon->get_all_coupons($start, $config["per_page"], $name);

    //     // echo "<pre>";
    //     // print_r($data['copun_list']);
    //     // die();
    ...
    //     $array_data = $this->coupon->get_all_coupons($start, $config["per_page"], $name);
    //     $option = '';
